...
DEMO_RESULT = {
    ...
    "emisor": "Juan Pérez",
    "productos": [
        {"categoria": "Carnicería", "producto": "Bisteck del 7",    "cantidad": 5,  "unidad": "kg"},
        {"categoria": "Carnicería", "producto": "Bisteck del cero", "cantidad": 2,  "unidad": "kg"},
        {"categoria": "Carnicería", "producto": "Milanesa de pollo","cantidad": 3,  "unidad": "kg"},
        {"categoria": "Frutería",   "producto": "Jitomate",         "cantidad": 4,  "unidad": "kg"},
        {"categoria": "Frutería",   "producto": "Cebolla",          "cantidad": 2,  "unidad": "kg"},
        {"categoria": "Frutería",   "producto": "Aguacate",         "cantidad": 1,  "unidad": "kg"},
        {"categoria": "Abarrotes",  "producto": "Aceite",           "cantidad": 3,  "unidad": "lt"},
        {"categoria": "Abarrotes",  "producto": "Frijol negro",     "cantidad": 5,  "unidad": "kg"},
        {"categoria": "Insumos",    "producto": "Papel de baño",    "cantidad": 2,  "unidad": "caja"},
        {"categoria": "Insumos",    "producto": "Jabón líquido",    "cantidad": 4,  "unidad": "lt"},
    ]
}
...
if st.session_state.parsed_data is None:
    ...
    provider = st.radio(
        label="Motor de IA",
        options=["OpenAI  (gpt-4o-mini)", "Gemini  (1.5 Flash)", "🧪 Demo  (sin API)"],
        horizontal=True,
...
# ─── SCREEN B: CHECKLIST ─────────────────────────────────────────────────────────
    ...
    model_badge = {"OpenAI": "GPT-4o mini", "Gemini": "Gemini 2.0 Flash", "Demo": "Modo Demo"}.get(provider_name, provider_name)
    st.markdown(f"""
    <div class="meta-pill">
